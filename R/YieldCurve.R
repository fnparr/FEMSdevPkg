...
#'   RQuantLib::yearFraction - used to compute arbitrage free forward rates.
...
setMethod(f = "YieldCurve", signature = c("character", "character","numeric",
          ...
          definition= function(yieldCurveID, referenceDate, tenorRates,
            ...
            # to RQuantLib:yearFraction dcc values; store both values in yc
            yfdccs <- c(6, 19, 0, 1, 10)
            names(yfdccs) <- c("30E360", "30E360ISDA", "A360", "A365", "AA")
            
            # Permitted dayCouunters values in the function RQuantLib::yearFraction() are:
            # "0" = "Actual360",
            # "1" = "Actual365Fixed",
            ...
            # "19" = "Thirty360.German"
            #
            # For reference: @DayCounter https://search.r-project.org/CRAN/refmans/RQuantLib/html/Enum.html
